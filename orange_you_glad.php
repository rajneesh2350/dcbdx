 ...
 */
    ...
    */   
   define('CC_FB_TO_EMAIL', 'rajneesh2350@yahoo.co.in');
   /**
    ...
    */  
   define('CC_FB_AUTO_REPLY_SUBJECT', 'Thanks for Your Interest,  [Name]');   
   /**
    ...
    */  
   define('CC_FB_RESULTS_REDIRECT', 'http://www.dcbdx.in');
   ...
   {      
      ...
      {      
         ...
         if(CC_FB_AUTO_REPLY)
         {
            $form_user_msg = parseMessage('Soon DC BDX Leggings - Pepole, Talk to you on your given Mobile Number
